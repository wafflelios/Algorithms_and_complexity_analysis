...
В строю отважной армии Сарумана друг за другом стоят 
n
n орков, рост 
i
i-го из них равен 
...
i
​
  условных единиц. Новобранец-орк Гримморхус тоже собирается встать в этот строй, причём Саруману хочется поставить Гримморхуса на такую позицию 
p
p, чтобы 
f
(
...
К сожалению ни Гримморхус, ни Саруман не могут точно вспомнить рост Гримморхуса, у них есть только 
m
m предположений о том, каким он может быть, и для каждого из них они хотели бы знать оптимальную позицию, на которую Гримморхусу стоило бы встать.
...
i
​
  - предполагаемый рост Гримморхуса (1 
⩽
⩽ 
m
,
...
В единственной строке выведите выведите m целых чисел - значение 
f
(
p
)
f(p) в оптимальной для данного роста позиции.
